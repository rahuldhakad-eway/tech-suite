                            ...
                            @foreach ($invoice->items as $item)
                                ...
                                @if ($item->type == 'item')
                                    <tr class="text-dark font-weight-semibold f-13">
                                        ...
                                        @endif
                                        <td align="right">{{ $item->quantity }} <br><span class="f-11 text-dark-grey">{{ $item->unit->unit_type }}</span></td>
                                        <td align="right">
                ...
                @foreach ($invoice->items as $item)
                    @if ($item->type == 'item')
                        ...
                        <tr>
                            ...
                            <td width="50%">{{ $item->quantity }} <br><span class="f-11 text-dark-grey">{{ $item->unit->unit_type }}</span></td>
                        </tr>
                        <tr>
                            <th width="50%" class="bg-light-grey text-dark-grey font-weight-bold">
