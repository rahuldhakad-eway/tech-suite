    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.invoiceSettings.contractPrefix')" :fieldPlaceholder="__('placeholders.invoices.contractPrefix')" fieldName="contract_prefix"
                fieldRequired="true" fieldId="contract_prefix" :fieldValue="$invoiceSetting->contract_prefix" />
        </div>
        ...
        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.invoiceSettings.contractNumberSeparator')" :fieldPlaceholder="__('placeholders.invoices.contractNumberSeparator')"
                fieldName="contract_number_separator" fieldId="contract_number_separator" :fieldValue="$invoiceSetting->contract_number_separator" />
        </div>

        <div class="col-lg-3">
            <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.invoiceSettings.contractDigit')" fieldName="contract_digit"
                fieldId="contract_digit" :fieldValue="$invoiceSetting->contract_digit" minValue="2" />
        </div>
...
<script>
    ...
    $('#invoice_prefix, #invoice_number_separator, #invoice_digit, #estimate_prefix,#estimate_number_separator, #estimate_digit, #credit_note_prefix, #credit_note_number_separator, #credit_note_digit, #contract_prefix, #contract_number_separator, #contract_digit, #order_prefix, #order_number_separator, #order_digit').on('keyup', function() {
