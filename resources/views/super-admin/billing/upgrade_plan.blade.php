                                        ...
                                        <div class="pricing-table price-@if($item->is_recommended == 1)pro @endif ">
                                            <div class="price-top">
                                                ...
                                                <div class="rate">
                                                    <h2 class="mb-2">
                                                        @if ($item->default == 'no')
                                                            <span class="font-weight-bolder">{{ global_currency_format($item->monthly_price, $item->currency_id) }}
                                                        @else
                                                            <span class="font-weight-normal f-14">@lang('superadmin.packages.yourDefaultPlan') <i class="fa fa-info-circle" data-toggle="tooltip" data-original-title="@lang('superadmin.packages.yourDefaultPlanInfo')"></i></span>
                                                        @endif

                                                    </h2>
                                                    <p class="mb-0">{!! ($item->default == 'no') ? __('superadmin.billedMonthly') : "&nbsp;" !!}</p>
                                                </div>
                                            </div>
                                            <div class="price-content">
                                                <ul class="ui-list">
                                                    ...
                                                    @if($item->is_free || $paymentActive || ($item->id == $company->package_id && $company->package_type == 'monthly'))
                                                        <li>
                                            ...
                                            <div class="price-top">
                                                ...
                                                <div class="rate">
                                                    <h2 class="mb-2">
                                                        ...
                                                        @if ($item->default == 'no')
                                                            <span class="font-weight-bolder">{{ global_currency_format($item->annual_price, $item->currency_id) }}
                                                        @else
                                                            <span class="font-weight-normal f-14">@lang('superadmin.packages.yourDefaultPlan') <i class="fa fa-info-circle" data-toggle="tooltip" data-original-title="@lang('superadmin.packages.yourDefaultPlanInfo')"></i></span>
                                                        @endif

                                                    </h2>
                                                    <p class="mb-0">{!! ($item->default == 'no') ? __('superadmin.billedAnnually') : "&nbsp;" !!}</p>
                                                </div>
                                            </div>
                                            <div class="price-content">
                                                <ul>
                                                    ...
                                                    @if($item->is_free || $paymentActive || ($item->id == $company->package_id && $company->package_type == 'annual'))
                                                        <li>
                                                            <x-forms.button-primary @class(['purchase-plan']) data-package-id="{{ $item->id }}" data-default="{{ $item->default }}" id="purchase-plan">@lang('superadmin.packages.choosePlan')</x-forms.button-primary>
                                                        </li>
                                                    @else
