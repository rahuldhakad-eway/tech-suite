    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                <x-forms.link-primary :link="route('superadmin.software-category.create')" class="mr-3 float-left openRightModal"
                    icon="plus">
                    @lang('app.add')
                    @lang('app.new')
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('superadmin.software-category.destroy', ':id') }}";
